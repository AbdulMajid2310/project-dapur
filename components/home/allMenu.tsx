            ...
            <motion.div className="flex overflow-x-auto w-full lg:w-auto pb-2 -mx-2 px-2 scrollbar-hide" variants={itemVariants}>
              {menuCategoriesData.map((category) => (
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className={`flex items-center justify-center min-w-max py-2.5 px-8 mx-1.5 rounded-full border transition-all duration-300 ${selectedCategory === category.id
              ...
              .map((item) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <motion.button
                      className={`w-full bg-[#9C633D] hover:bg-[#7a4d2f] text-white py-3 rounded-2xl font-bold transition-all flex items-center justify-center shadow-lg shadow-orange-900/20 ${addingToCart === item.menuItemId ? "opacity-70 cursor-not-allowed" : ""
                        }`}
